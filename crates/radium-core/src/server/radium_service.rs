...
use crate::proto::{
    ...
    GetAgentRequest, GetAgentResponse, GetMessagesRequest, GetMessagesResponse,
    GetRegisteredAgentsRequest, GetRegisteredAgentsResponse, GetTaskRequest, GetTaskResponse,
    GetWorkerStatusRequest, GetWorkerStatusResponse, GetWorkflowExecutionRequest,
    GetWorkflowExecutionResponse, GetWorkflowRequest, GetWorkflowResponse, ListAgentsRequest,
    ListAgentsResponse, ListTasksRequest, ListTasksResponse, ListWorkflowExecutionsRequest,
