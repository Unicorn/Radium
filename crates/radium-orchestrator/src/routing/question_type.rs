//! Question type detection for intelligent agent routing and context building.
...
mod tests {
    ...
    fn test_architecture_detection() {
        assert_eq!(
            QuestionType::detect("How does the authentication work?"),
            QuestionType::Architecture
        );
    }
    ...
    fn test_implementation_detection() {
        assert_eq!(
            QuestionType::detect("How is the user service implemented?"),
            QuestionType::Implementation
        );
    }
