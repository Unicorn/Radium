...
use radium_core::proto::{
    Agent, CreateAgentRequest, CreateTaskRequest, CreateWorkflowRequest, Task, Workflow,
};
...
async fn test_app_refresh_dashboard_success() {
    ...
    // Agent
    client
        .create_agent(tonic::Request::new(CreateAgentRequest {
            agent: Some(Agent {
    ...
    // Workflow
    client
        .create_workflow(tonic::Request::new(CreateWorkflowRequest {
    ...
    // Task
    client
        .create_task(tonic::Request::new(CreateTaskRequest {
            task: Some(Task {
