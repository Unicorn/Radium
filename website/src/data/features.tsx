		...
		features: [
			{
				...
				description: (
					<React.Fragment>
						Radium automatically selects the best agent for each task based on
						capabilities, cost, and performance. No manual routing required—the
						orchestrator handles agent selection using policy-driven decision
						making.
					</React.Fragment>
				),
				codeExample: {
...
timeout = 30`,
				...
				links: [
					{
						label: "Orchestration Guide",
						href: "/docs/user-guide/orchestration",
					},
			...
			},
			{
				...
				description: (
					<React.Fragment>
						Define complex workflows as directed acyclic graphs (DAGs) with
						multiple agents working in parallel or sequence. Built-in dependency
						resolution, automatic retries, and failure handling ensure reliable
						execution.
					</React.Fragment>
				),
				codeExample: {
...
parallel = ["security-scan"]`,
			...
			},
			{
				...
				description: (
					<React.Fragment>
						Enable agents to run autonomously with minimal human intervention.
						Agents can make decisions, execute tasks, and handle errors
						independently. Perfect for long-running tasks or trusted
						environments.
					</React.Fragment>
				),
				codeExample: {
...
radium-cli chat code-assistant \\
  ...
  --budget 5.00`,
				...
				links: [
					{
						...
						href: "/docs/user-guide/execution-modes",
					},
	...
	},
	{
		...
		description:
			"Simple, declarative configuration for creating and managing agents",
		features: [
			{
				id: "toml-config",
				...
				description: (
					<React.Fragment>
						Define agents using simple TOML files. No code required—just declare
						your agent's capabilities, model preferences, and behavior. Version
						control friendly and easy to share.
					</React.Fragment>
				),
				codeExample: {
					language: "toml",
...
verbosity = "detailed"`,
				...
				links: [
					{
						...
						href: "/docs/user-guide/agent-configuration",
					},
			...
			},
			{
				...
				description: (
					<React.Fragment>
						Personas define agent behavior, expertise, and communication style.
						Mix and match personas with different models to find the perfect
						combination for your use case. Extensible and customizable.
					</React.Fragment>
				),
				codeExample: {
					language: "toml",
...
"""`,
			...
			},
			{
				...
				description: (
					<React.Fragment>
						Run models locally using Ollama or connect to your own inference
						servers. Full privacy and control over your data. Supports
...
api_key = "{{ env.CUSTOM_API_KEY }}"`,
				...
				links: [
					{
						...
						href: "/docs/user-guide/model-providers",
					},
					{
						label: "Ollama Integration",
						href: "/docs/user-guide/guides/ollama-integration",
					},
				],
			},
		],
	},
	{
		...
		description:
			"Enterprise-grade security and governance for autonomous agents",
		features: [
			{
				id: "policy-engine",
				title: "Policy Engine",
				description: (
					<React.Fragment>
						Define fine-grained policies to control agent behavior, resource
						usage, and decision-making. Policies can enforce approval workflows,
						cost limits, rate limiting, and more.
					</React.Fragment>
				),
				codeExample: {
					language: "toml",
...
quarantine_suspicious = true`,
			...
			},
			{
				...
				description: (
					<React.Fragment>
						Control how workflows handle errors, retries, and edge cases.
						Built-in behaviors include graceful degradation, circuit breakers,
						exponential backoff, and custom error recovery strategies.
					</React.Fragment>
				),
				codeExample: {
					language: "toml",
...
alert_on_failure = true`,
			...
			},
			{
				...
				description: (
					<React.Fragment>
						Continuous monitoring of agent behavior and outputs. The vibe check
						system detects anomalies, hallucinations, and unexpected behavior
						patterns. Acts as a second layer of safety for autonomous agents.
					</React.Fragment>
				),
				codeExample: {
					language: "toml",
		...
		features: [
			{
				...
				description: (
					<React.Fragment>
						Choose your preferred interface: CLI for automation and scripting,
						TUI for interactive sessions, or Desktop app for visual workflows.
						All interfaces share the same underlying engine and configuration.
					</React.Fragment>
				),
				codeExample: {
					language: "bash",
...
cargo add radium-core`,
			...
			},
			{
				...
				description: (
					<React.Fragment>
						Extend Radium with custom tools, data sources, and integrations.
						Extensions are first-class citizens with full access to the agent
						runtime. Share your extensions with the community.
					</React.Fragment>
				),
				codeExample: {
					language: "rust",
    ...
    fn create_pr(&self, params: PrParams) -> Result<PullRequest> {
        // Another tool
				...
				links: [
					{
						...
						href: "/docs/developer-guide/extensions",
					},
			...
			},
			{
				...
				description: (
					<React.Fragment>
						Track costs, performance, and agent behavior across sessions.
						Built-in analytics help you optimize workflows, reduce costs, and
						improve agent performance over time. Export data for custom
						analysis.
					</React.Fragment>
				),
				codeExample: {
...
radium-cli stats agents --sort-by avg_latency`,
				...
				links: [
					{ label: "Analytics Guide", href: "/docs/user-guide/analytics" },
					{
						...
						href: "/docs/user-guide/cost-optimization",
					},
				],
			},
		],
