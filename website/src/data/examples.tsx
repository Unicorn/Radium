...
export const examples: Example[] = [
	{
		...
		description: (
			<React.Fragment>
				Orchestrate multiple agents to analyze, review, and improve code.
				Demonstrates DAG workflows, agent coordination, and error handling with
				automatic retries.
			</React.Fragment>
		),
		category: "workflow",
...
steps = [
  ...
  { agent = "reviewer", depends_on = ["analyzer"] }
	...
	},
	{
		...
		description: (
			<React.Fragment>
				Run agents completely locally using Ollama. No API keys required -
				perfect for privacy-sensitive applications or offline development.
				Supports CodeLlama, Mistral, and more.
			</React.Fragment>
		),
...
base_url = "http://localhost:11434"`,
	...
	},
	{
		...
		description: (
			<React.Fragment>
				Automatically select the most cost-effective model for each task. Uses
				policy-driven orchestration to balance cost, speed, and quality based on
				your requirements.
			</React.Fragment>
		),
		category: "workflow",
...
complex_tasks = ["gpt-4", "claude-sonnet"]`,
	...
	},
	{
		...
		description: (
			<React.Fragment>
				Enable agents to autonomously debug failing tests. Demonstrates YOLO
				mode, bounded autonomy, and intelligent error recovery with minimal
				human intervention.
			</React.Fragment>
		),
		category: "automation",
...
on_anomaly = "pause-and-notify"`,
	...
	},
	{
		...
		description: (
			<React.Fragment>
				Integrate Radium agents into your CI/CD pipeline. Automate code reviews,
				documentation generation, and test creation as part of your build
				process.
			</React.Fragment>
		),
		category: "automation",
	...
	},
	{
		...
		description: (
			<React.Fragment>
				Create custom tools and integrations for your agents. This example shows
				how to build a GitHub extension that lets agents search issues, create
				PRs, and manage repositories.
			</React.Fragment>
		),
...
impl GitHubExtension {
	...
	},
	{
		...
		description: (
			<React.Fragment>
				Define custom personas to shape agent behavior and expertise. This
				example creates a security-focused reviewer with specific knowledge
				domains and communication style.
			</React.Fragment>
		),
		category: "workflow",
		difficulty: "beginner",
...
"""`,
	...
	},
	{
		...
		description: (
			<React.Fragment>
				Build intelligent ETL pipelines with AI-powered data validation and
				transformation. Agents can detect anomalies, suggest optimizations, and
