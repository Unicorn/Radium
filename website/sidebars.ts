	...
	docsSidebar: [
		...
		// 4. Features
		{
			...
			items: [
				...
				},
				{
					type: "category",
					label: "YOLO Mode",
					items: ["features/yolo-mode/integration-map"],
				},
			],
		},
		...
		// 10. Specifications
		{
			...
			items: [
				...
				},
				{
					type: "category",
					label: "Vision",
					items: ["specifications/vision/whitepaper-architecture"],
				},
			],
		},
		...
		// 11. Developer Guide
		{
			...
			items: [
				...
				},
				{
					type: "category",
					label: "Design",
					items: ["developer-guide/design/persona-system-architecture"],
				},
				{
					type: "category",
					label: "Development",
				...
				},
				{
					type: "category",
					label: "ADR",
					items: ["developer-guide/adr/001-yolo-mode-architecture"],
				},
				{
					type: "category",
					label: "Guides",
					items: ["developer-guide/guides/json-schema-guide"],
				},
			],
		},
		...
		// 12. API Reference
		{
			...
			items: [
				...
				{
					type: "link",
					label: "→ radium-abstraction",
					href: "/api/radium_abstraction",
				},
				{
					type: "link",
					label: "→ radium-models",
					href: "/api/radium_models",
				},
				{
					type: "link",
					label: "→ radium-orchestrator",
					href: "/api/radium_orchestrator",
				},
			],
		},
